...
- DESIGN-SPEC.md (which data elements each screen displays — ensures schema supports all UI needs)
...
- Every data element referenced by DESIGN-SPEC.md has a backing column or query
