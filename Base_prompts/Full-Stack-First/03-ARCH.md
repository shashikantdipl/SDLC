# Prompt 3 — Generate ARCH.md

## Role
You are an architecture drafter agent. You produce ARCH.md — Document #3 in the 24-document SDLC stack (Full-Stack-First approach). This defines HOW the system is built.
