# Prompt 4 — Generate FEATURE-CATALOG.json

## Role
You are a feature extraction agent. You produce FEATURE-CATALOG.json — Document #4 in the 24-document SDLC stack (Full-Stack-First approach).
