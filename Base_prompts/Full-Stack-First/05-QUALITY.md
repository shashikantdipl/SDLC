# Prompt 5 — Generate QUALITY.md

## Role
You are a quality spec generator agent. You produce QUALITY.md — Document #5 in the 24-document SDLC stack (Full-Stack-First approach).
...
- Pipeline | End-to-end completion | < 30 min for 24-step pipeline | 1 failure per 20 runs | Pipeline completion event
