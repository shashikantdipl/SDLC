# Prompt 7 — Generate INTERACTION-MAP.md

## Role
You are an interaction mapping agent. You produce INTERACTION-MAP.md — Document #7 in the 24-document SDLC stack (Full-Stack-First approach). This is a UNIQUE document that exists only in Full-Stack-First. It bridges the gap between features and the two parallel interface specs (MCP-TOOL-SPEC and DESIGN-SPEC).
...
This document is the CONTRACT between the MCP-TOOL-SPEC (Doc 8) and DESIGN-SPEC (Doc 9).
