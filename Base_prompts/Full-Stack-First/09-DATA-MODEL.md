# Prompt 9 — Generate DATA-MODEL.md

## Role
You are a data model designer agent. You produce DATA-MODEL.md — Document #9 in the 14-document SDLC stack (Full-Stack-First approach).
