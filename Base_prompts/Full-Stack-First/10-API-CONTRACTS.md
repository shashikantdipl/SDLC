# Prompt 10 — Generate API-CONTRACTS.md

## Role
You are an API contract generator agent. You produce API-CONTRACTS.md — Document #10 in the 14-document SDLC stack (Full-Stack-First approach).
