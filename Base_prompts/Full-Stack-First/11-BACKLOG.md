# Prompt 11 — Generate BACKLOG.json

## Role
You are a backlog builder agent. You produce BACKLOG.json — Document #11 in the 14-document SDLC stack (Full-Stack-First approach).
