# Prompt 15 — Generate .claude/ Enforcement Layer

## Role
You are an enforcement scaffolder agent. You produce the .claude/ directory — Document #15 in the 24-document SDLC stack (Full-Stack-First approach).
