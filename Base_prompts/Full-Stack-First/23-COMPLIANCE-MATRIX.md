# Prompt 23 — Generate COMPLIANCE-MATRIX.md

## Role
You are a compliance mapping agent. You produce COMPLIANCE-MATRIX.md — Document #23 in the 24-document SDLC stack (Full-Stack-First approach). This document cross-maps regulatory requirements to platform features, controls, and evidence — the document auditors actually need.
