...
>
> **Approach:** Full-Stack-First (24-document suite). AI interfaces (MCP tools) and human interfaces (dashboard screens) designed in parallel from a shared INTERACTION-MAP, backed by a unified backend.
>
...
The Full-Stack-First approach produces **24 documents**. The key differentiator from API-First or Design-First is that the **INTERACTION-MAP (Doc 07)** serves as the single coordination document from which both **MCP-TOOL-SPEC (Doc 08)** and **DESIGN-SPEC (Doc 09)** are derived in parallel. This ensures AI interfaces and human interfaces share the same interaction model.

### 2.1 Complete Build Sequence

| Step | Doc # | Document | File Path | Inputs | Parallel With | Status |
|------|-------|----------|-----------|--------|---------------|--------|
| 1 | 00 | **BRD** | `Generated-Docs/00-BRD.md` | Raw spec | Step 2 | NOT STARTED |
| 2 | 01 | **ROADMAP** | `Generated-Docs/01-ROADMAP.md` | Raw spec | Step 1 | **THIS DOC** |
| 3 | 02 | **PRD** | `Generated-Docs/02-PRD.md` | Raw spec | Step 2 | NOT STARTED |
| 4 | 03 | **ARCH** | `Generated-Docs/03-ARCH.md` | PRD | — | NOT STARTED |
| 5 | 04 | **FEATURE-CATALOG** | `Generated-Docs/04-FEATURE-CATALOG.md` | PRD + ARCH | Steps 5, 6 | NOT STARTED |
| 6 | 05 | **QUALITY** | `Generated-Docs/05-QUALITY.md` | PRD + ARCH | Steps 5, 4 | NOT STARTED |
| 7 | 06 | **SECURITY-ARCH** | `Generated-Docs/06-SECURITY-ARCH.md` | ARCH | — | NOT STARTED |
| 8 | 07 | **INTERACTION-MAP** | `Generated-Docs/07-INTERACTION-MAP.md` | PRD + ARCH + FEATURES + QUALITY | — | NOT STARTED |
| 9 | 08 | **MCP-TOOL-SPEC** | `Generated-Docs/08-MCP-TOOL-SPEC.md` | INTERACTION-MAP + ARCH + FEATURES + QUALITY | **Step 10** | NOT STARTED |
| 10 | 09 | **DESIGN-SPEC** | `Generated-Docs/09-DESIGN-SPEC.md` | INTERACTION-MAP + PRD + QUALITY + FEATURES | **Step 9** | NOT STARTED |
| 11 | 10 | **DATA-MODEL** | `Generated-Docs/10-DATA-MODEL.md` | ARCH + FEATURES + QUALITY + MCP-TOOL-SPEC + DESIGN-SPEC + INTERACTION-MAP | — | NOT STARTED |
| 12 | 11 | **API-CONTRACTS** | `Generated-Docs/11-API-CONTRACTS.md` | ARCH + DATA-MODEL + PRD + MCP-TOOL-SPEC + DESIGN-SPEC + INTERACTION-MAP | — | NOT STARTED |
| 13 | 12 | **USER-STORIES** | `Generated-Docs/12-USER-STORIES.md` | PRD + FEATURE-CATALOG | — | NOT STARTED |
| 14 | 13 | **BACKLOG** | `Generated-Docs/13-BACKLOG.md` | All above | — | NOT STARTED |
| 15 | 14 | **CLAUDE** | `Generated-Docs/14-CLAUDE.md` | ROADMAP + ARCH | — | NOT STARTED |
| 16 | 15 | **ENFORCEMENT** | `Generated-Docs/15-ENFORCEMENT.md` | CLAUDE + ARCH | Steps 16, 18 | NOT STARTED |
| 17 | 16 | **INFRA-DESIGN** | `Generated-Docs/16-INFRA-DESIGN.md` | ARCH + DATA-MODEL | — | NOT STARTED |
| 18 | 17 | **MIGRATION-PLAN** | `Generated-Docs/17-MIGRATION-PLAN.md` | DATA-MODEL + INFRA-DESIGN | — | NOT STARTED |
| 19 | 18 | **TESTING** | `Generated-Docs/18-TESTING.md` | ARCH + QUALITY + DATA-MODEL + CLAUDE + MCP-TOOL-SPEC + DESIGN-SPEC + INTERACTION-MAP | Steps 15, 16 | NOT STARTED |
| 20 | 19 | **FAULT-TOLERANCE** | `Generated-Docs/19-FAULT-TOLERANCE.md` | ARCH + INFRA-DESIGN | — | NOT STARTED |
| 21 | 20 | **GUARDRAILS-SPEC** | `Generated-Docs/20-GUARDRAILS-SPEC.md` | SECURITY-ARCH + QUALITY | — | NOT STARTED |
| 22 | 21 | **COMPLIANCE-MATRIX** | `Generated-Docs/21-COMPLIANCE-MATRIX.md` | SECURITY-ARCH + TESTING | — | NOT STARTED |
| 23 | 22 | **AGENT-HANDOFF-PROTOCOL** | `Generated-Docs/22-AGENT-HANDOFF-PROTOCOL.md` | Build Sequence + ARCH + CLAUDE + QUALITY | — | NOT STARTED |
| 24 | 23 | **AGENT-INTERACTION-DIAGRAM** | `Generated-Docs/23-AGENT-INTERACTION-DIAGRAM.md` | AGENT-HANDOFF-PROTOCOL | — | NOT STARTED |
...
```
              ...
              [00] BRD        [01] ROADMAP    [02] PRD
                    ...
                    +-----------+--------+--+--------+-----------+
                    |           |        |           |           |
              [04] FEATURE  [05] QUALITY |    [06] SECURITY  [14] CLAUDE
                    |           |        |                       |
                    +-----+-----+        |                       |
                          |              |                 [15] ENFORCEMENT
                [07] INTERACTION-MAP     |                       |
              ...
              +-----------+-----------+  |
              |                       |  |
      [08] MCP-TOOL-SPEC   [09] DESIGN-SPEC     <--- PARALLEL SPRINT
              |                       |
              +-----------+-----------+
                          |
                 [10] DATA-MODEL
          ...
          +-------+-------+-------+-------+
          |       |       |       |       |
    [12] USER  [13] BACKLOG [16] INFRA [19] FAULT
     STORIES        |       |       TOLERANCE
                    |  [17] MIGRATION
                    |       |
                    | [20] GUARDRAILS  [21] COMPLIANCE
                    |
...
The INTERACTION-MAP (Doc 07) defines every touchpoint in the system:
...
|-----|----------|-------------|------------|
| D1 | Generate ROADMAP + PRD in parallel (Steps 1-2) | `Generated-Docs/01-ROADMAP.md` | This document, reviewed |
| D1 | Generate PRD in parallel with ROADMAP | `Generated-Docs/02-PRD.md` | Personas defined, all 48 agents categorized, 9 missing agents specified |
| D3 | Generate ARCH (depends on PRD) | `Generated-Docs/03-ARCH.md` | All 5 orchestration levels documented, 7 protocol patterns defined |
| D4 | Generate CLAUDE (depends on ROADMAP + ARCH) | `Generated-Docs/14-CLAUDE.md` | Repo structure rules, forbidden patterns, agent conventions |
...
| Day | Activity | Output File | Acceptance |
|-----|----------|-------------|------------|
| D1-D2 | Generate FEATURE-CATALOG + QUALITY in parallel (Steps 5-6) | `Generated-Docs/04-FEATURE-CATALOG.md` | F-NNN features for all 48+9 agents, dependency graph, priority assignment |
| D1-D2 | (parallel) | `Generated-Docs/05-QUALITY.md` | Q-NNN NFRs with measurable thresholds for every agent category |
| D3-D5 | Generate INTERACTION-MAP (Step 8, depends on all above) | `Generated-Docs/07-INTERACTION-MAP.md` | Every agent touchpoint identified; every dashboard screen mapped; every MCP tool touchpoint cataloged; zero orphan interactions |
...
| Day | Activity | Output File | Acceptance |
|-----|----------|-------------|------------|
| D1-D5 | Generate MCP-TOOL-SPEC (AI interface, Step 9) | `Generated-Docs/08-MCP-TOOL-SPEC.md` | Every MCP tool has typed input/output schemas; tool-to-agent mapping complete; references INTERACTION-MAP touchpoint IDs |
| D1-D5 | Generate DESIGN-SPEC (human interface, Step 10) | `Generated-Docs/09-DESIGN-SPEC.md` | Every Streamlit screen wireframed; screen-to-agent mapping complete; references INTERACTION-MAP touchpoint IDs |
...
| Day | Activity | Output File | Acceptance |
|-----|----------|-------------|------------|
| D1-D5 | Generate DATA-MODEL (Step 11) | `Generated-Docs/10-DATA-MODEL.md` | All tables defined; migrations 005-008 SQL included; entity-relationship diagram; covers MCP + Design entities |
| D6-D10 | Generate API-CONTRACTS (Step 12) | `Generated-Docs/11-API-CONTRACTS.md` | REST + WebSocket endpoints; request/response schemas; MCP tool endpoints; dashboard endpoints; auth model |
...
| Entry Criteria | Exit Criteria |
|---------------|---------------|
| All upstream documents committed (Docs 00-11) | BACKLOG has every work item with priority, estimate, and agent assignment |
...
| Day | Activity | Output File | Acceptance |
|-----|----------|-------------|------------|
| D1-D3 | Generate BACKLOG (Step 14) | `Generated-Docs/13-BACKLOG.md` | S-NNN stories for all FIX items, all 9 missing agents, all 5 missing pipelines; prioritized P1-P5 |
| D2-D4 | Generate ENFORCEMENT (Step 16, parallel with BACKLOG tail + TESTING) | `Generated-Docs/15-ENFORCEMENT.md` | Rules derived from CLAUDE + ARCH; `.claude/` enforcement config generated |
| D2-D5 | Generate TESTING (Step 19, parallel with ENFORCEMENT) | `Generated-Docs/18-TESTING.md` | Test strategy for all SDK modules; contract tests for MCP tools; E2E test plan for team pipelines |
...
**Duration:** 5 days (1 week)
**Goal:** Define agent handoff protocol and produce the interaction diagram. Complete the 24-document set.
...
|  | **All 24 documents committed** — documentation phase complete |

**Deliverables:**

| Day | Activity | Output File | Acceptance |
|-----|----------|-------------|------------|
| D1-D3 | Generate AGENT-HANDOFF-PROTOCOL (Step 23) | `Generated-Docs/22-AGENT-HANDOFF-PROTOCOL.md` | Typed message envelopes for all 7 protocol patterns; handoff sequences for all team workflows; error recovery paths |
| D4-D5 | Generate AGENT-INTERACTION-DIAGRAM (Step 24) | `Generated-Docs/23-AGENT-INTERACTION-DIAGRAM.md` | Visual diagram (Mermaid or ASCII) of all agents; swimlanes by SDLC phase; pipeline flows marked |
...
| Entry Criteria | Exit Criteria |
|---------------|---------------|
| All 24 documents committed and reviewed | SessionStore passes integration tests (8+ tests) |
...
|----|-----------|-------------|--------------------------|
| G1 | Foundation documents complete | W1 | `Generated-Docs/01-ROADMAP.md` through `Generated-Docs/03-ARCH.md` plus `Generated-Docs/14-CLAUDE.md` committed and peer-reviewed; zero open TBDs |
| G2 | INTERACTION-MAP signed off | W2 | `Generated-Docs/07-INTERACTION-MAP.md` committed; covers all 48 agents, all dashboard screens, all MCP tool touchpoints |
| G3 | Parallel MCP + Design sprint complete | W3 | `Generated-Docs/08-MCP-TOOL-SPEC.md` and `Generated-Docs/09-DESIGN-SPEC.md` committed; every INTERACTION-MAP touchpoint has coverage |
| G4 | Data + API layer complete | W5 | `Generated-Docs/10-DATA-MODEL.md` and `Generated-Docs/11-API-CONTRACTS.md` committed; migrations 005-008 SQL defined |
| G5 | All 24 documents committed | W7 | All files `Generated-Docs/00-BRD.md` through `Generated-Docs/23-AGENT-INTERACTION-DIAGRAM.md` exist; no unresolved TBDs |
...
| OD-07 | **MCP tool granularity** | (A) 1:1 — one MCP tool per agent (48 tools). (B) 7 phase-level tools with sub-commands. (C) Hybrid — phase-level tools + key individual agents exposed directly. | Platform team | MCP-TOOL-SPEC (Doc 08), API surface area, client complexity | W2 |
...
| R-08 | **LLM API cost overrun during 48-agent implementation.** At $0.134/call (B1) with hundreds of test iterations per agent, Phases 8-9 could cost $200-500 in API calls. | MEDIUM | MEDIUM | Use dry-run mode for development iterations. Real API calls only for acceptance tests. Track daily spend. Alert at 80% of $50/day fleet ceiling. Budget $500 for entire Phase 8-9 testing. Use Ollama (free) for local dev iterations. |
| R-09 | **9 missing agents have undefined requirements.** Names exist but no functional spec, no prompt strategy, no expected output schema. | MEDIUM | MEDIUM | PRD (Doc 02) MUST define functional requirements for all 9 new agents. FEATURE-CATALOG (Doc 04) MUST include them. Do not defer specification to implementation phase. |
...
| R-13 | **LLM provider lock-in.** Hard dependency on a single LLM vendor creates business and technical risk if pricing changes, service degrades, or features diverge. | LOW | HIGH | MITIGATED by `sdk/llm/` LLMProvider interface. Abstract provider layer supports Anthropic, OpenAI, and Ollama. Agents use tier-based model selection (`fast`/`balanced`/`powerful`) instead of hardcoded model names. Switching providers requires only `LLM_PROVIDER=<name>` env var change. |
| R-11 | **INTERACTION-MAP quality determines everything downstream.** If Doc 07 has gaps, both MCP-TOOL-SPEC and DESIGN-SPEC inherit those gaps, and they propagate through DATA-MODEL and API-CONTRACTS. | MEDIUM | CRITICAL | Allocate 3 full days for INTERACTION-MAP (D3-D5 of Phase 1). Require sign-off from all team members. Run a "touchpoint audit": for every agent, confirm there is an AI path AND a human path. |
...
|------------------------|--------------------------------------|
| **[01] ROADMAP** | [14] CLAUDE |
| **[02] PRD** | [03] ARCH, [04] FEATURE-CATALOG, [05] QUALITY, [07] INTERACTION-MAP, [09] DESIGN-SPEC, [11] API-CONTRACTS, [13] BACKLOG |
| **[03] ARCH** | [14] CLAUDE, [04] FEATURE-CATALOG, [05] QUALITY, [07] INTERACTION-MAP, [08] MCP-TOOL-SPEC, [10] DATA-MODEL, [11] API-CONTRACTS, [15] ENFORCEMENT, [18] TESTING, [22] AGENT-HANDOFF-PROTOCOL |
| **[14] CLAUDE** | [15] ENFORCEMENT, [18] TESTING, [22] AGENT-HANDOFF-PROTOCOL |
| **[05] QUALITY** | [07] INTERACTION-MAP, [08] MCP-TOOL-SPEC, [09] DESIGN-SPEC, [10] DATA-MODEL, [18] TESTING |
| **[04] FEATURE-CATALOG** | [07] INTERACTION-MAP, [08] MCP-TOOL-SPEC, [09] DESIGN-SPEC, [10] DATA-MODEL |
| **[07] INTERACTION-MAP** | [08] MCP-TOOL-SPEC, [09] DESIGN-SPEC, [10] DATA-MODEL, [11] API-CONTRACTS, [18] TESTING |
| **[08] MCP-TOOL-SPEC** | [10] DATA-MODEL, [11] API-CONTRACTS, [18] TESTING |
| **[09] DESIGN-SPEC** | [10] DATA-MODEL, [11] API-CONTRACTS, [18] TESTING |
| **[10] DATA-MODEL** | [11] API-CONTRACTS, [18] TESTING |
| **[11] API-CONTRACTS** | [13] BACKLOG |
| **[22] AGENT-HANDOFF-PROTOCOL** | [23] AGENT-INTERACTION-DIAGRAM |

**Key insight:** Changing ARCH (Doc 03) triggers the largest cascade — 10 downstream documents. This is why ARCH freezes early.
...
|----------|-------------|-------------------|
| [01] ROADMAP | End of Phase 0 (G1) | Change Request approved by platform lead |
| [02] PRD | End of Phase 0 (G1) | Change Request approved by platform lead |
| [03] ARCH | End of Phase 1 (G2) | Change Request approved by platform lead + impact analysis |
| [14] CLAUDE | End of Phase 1 (G2) | Change Request approved by platform lead |
| [05] QUALITY | Start of Phase 2 (before G3) | Change Request + INTERACTION-MAP impact review |
| [04] FEATURE-CATALOG | Start of Phase 2 (before G3) | Change Request + INTERACTION-MAP impact review |
| [07] INTERACTION-MAP | Start of Phase 2 (before G3) | Synchronous review by both MCP and Design authors; both must approve |
| [08] MCP-TOOL-SPEC | End of Phase 2 (G3) | Change Request + DATA-MODEL impact analysis |
| [09] DESIGN-SPEC | End of Phase 2 (G3) | Change Request + DATA-MODEL impact analysis |
| [10] DATA-MODEL | End of Phase 3 (G4) | Change Request + migration compatibility proof |
| [11] API-CONTRACTS | End of Phase 3 (G4) | Change Request + backward compatibility proof |
| [12-23] All remaining | G5 milestone (W7) | Formal change request process only |

**Hard freeze:** After G5 (all 24 docs committed, W7), no document changes without a formal Change Request.
...
Generated-Docs/
  ...
  15-ENFORCEMENT.md
  16-INFRA-DESIGN.md
  17-MIGRATION-PLAN.md
  18-TESTING.md
  19-FAULT-TOLERANCE.md
  20-GUARDRAILS-SPEC.md
  21-COMPLIANCE-MATRIX.md
  22-AGENT-HANDOFF-PROTOCOL.md
  23-AGENT-INTERACTION-DIAGRAM.md
  change-requests/
    CR-001-example.md
  archive/
    01-ROADMAP-v0.9.md
...
```json
{
  ...
  "documents": [
    ...
    },
    {
      ...
      "last_modified": null,
      "depends_on": [],
      "depended_by": [3, 4, 5, 7, 9, 11, 13]
    },
    {
      "number": 7,
      "name": "INTERACTION-MAP",
      "file": "07-INTERACTION-MAP.md",
      "version": null,
      "status": "NOT_STARTED",
      "frozen": false,
      "freeze_at": "G3-start",
...
> Note: Only 3 entries shown for illustration. The full file will contain all 24 documents.
...
4. **24 documents** — all committed, all cross-references valid, all frozen
...
| v1.0 | 2026-03-24 | Platform team | Rewritten for Full-Stack-First approach (24 docs); added INTERACTION-MAP as key coordination doc; added parallel MCP+Design sprint; added AGENT-HANDOFF-PROTOCOL and AGENT-INTERACTION-DIAGRAM; expanded timeline to 20 weeks |
