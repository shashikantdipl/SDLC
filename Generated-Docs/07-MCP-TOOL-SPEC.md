...
**Document:** 7 of 14 | Status: Draft
**Reads from:** INTERACTION-MAP (Doc 6) --- all tool names, data shapes, and interaction IDs are defined there.
...
| **Description** | Generate a complete 14-document set for a new software project. |
...
**Generated Prompt:**
```
Generate a complete 14-document set for the following project:
...
All data shapes are defined in the INTERACTION-MAP (Doc 6). This appendix provides a quick-reference summary for implementers.
...
*End of MCP-TOOL-SPEC --- Document 7 of 14*
