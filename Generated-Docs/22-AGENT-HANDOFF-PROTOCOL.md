...
**Document:** 22 of 24 | Status: Draft
...
This document defines the meta-protocol governing how the 24 document-generating agents communicate, pass context, validate outputs, and handle failures within the Full-Stack-First document generation pipeline. It is the operational contract between:

- **The Orchestrator** — the pipeline controller that sequences agent execution
- **The 24 Agents** — each responsible for generating one SDLC document (Docs 00-23)
...
**Scope:** This protocol governs the document generation pipeline only. It does not govern the 48 runtime agents described in the ARCH (Doc 03). Those runtime agents are a product feature; these 24 agents are the build-time pipeline that produces the specification documents.
...
|----------|------|-------------------|----------|-------------------|-------------------|----------------------|
| `D0-brd` | 1 | 00-BRD.md | `anthropic` | `raw_spec` | `brd_doc` | None |
| `D1-roadmap` | 2 | 01-ROADMAP.md | `anthropic` | `raw_spec` | `roadmap_doc` | None |
| `D2-prd` | 3 | 02-PRD.md | `anthropic` | `raw_spec` | `prd_doc` | None |
| `D3-arch` | 4 | 03-ARCH.md | `anthropic` | `prd_doc` | `arch_doc` | D2-prd |
| `D4-features` | 5 | 04-FEATURE-CATALOG.md | `anthropic` | `prd_doc`, `arch_doc` | `feature_catalog` | D2-prd, D3-arch |
| `D5-quality` | 6 | 05-QUALITY.md | `anthropic` | `prd_doc`, `arch_doc` | `quality_doc` | D2-prd, D3-arch |
| `D6-security` | 7 | 06-SECURITY-ARCH.md | `anthropic` | `arch_doc`, `quality_doc` | `security_arch` | D3-arch, D5-quality |
| `D7-interaction` | 8 | 07-INTERACTION-MAP.md | `anthropic` | `prd_doc`, `arch_doc`, `feature_catalog`, `quality_doc` | `interaction_map` | D2-prd, D3-arch, D4-features, D5-quality |
| `D8-mcp` | 9 | 08-MCP-TOOL-SPEC.md | `anthropic` | `interaction_map`, `arch_doc`, `feature_catalog`, `quality_doc` | `mcp_tool_spec` | D3-arch, D4-features, D5-quality, D7-interaction |
| `D9-design` | 10 | 09-DESIGN-SPEC.md | `anthropic` | `interaction_map`, `prd_doc`, `quality_doc`, `feature_catalog` | `design_spec` | D2-prd, D5-quality, D4-features, D7-interaction |
| `D10-data` | 11 | 10-DATA-MODEL.md | `anthropic` | `arch_doc`, `feature_catalog`, `quality_doc`, `mcp_tool_spec`, `design_spec`, `interaction_map` | `data_model` | D3-arch, D4-features, D5-quality, D7-interaction, D8-mcp, D9-design |
| `D11-api` | 12 | 11-API-CONTRACTS.md | `anthropic` | `arch_doc`, `data_model`, `prd_doc`, `mcp_tool_spec`, `design_spec`, `interaction_map` | `api_contracts` | D2-prd, D3-arch, D7-interaction, D8-mcp, D9-design, D10-data |
| `D12-stories` | 13 | 12-USER-STORIES.md | `anthropic` | `prd_doc`, `feature_catalog`, `interaction_map` | `user_stories` | D2-prd, D4-features, D7-interaction |
| `D13-backlog` | 14 | 13-BACKLOG.md | `anthropic` | `feature_catalog`, `prd_doc`, `arch_doc`, `quality_doc`, `mcp_tool_spec`, `design_spec`, `interaction_map` | `backlog` | D2-prd, D3-arch, D4-features, D5-quality, D7-interaction, D8-mcp, D9-design |
| `D14-claude` | 15 | 14-CLAUDE.md | `anthropic` | `roadmap_doc`, `arch_doc` | `claude_doc` | D1-roadmap, D3-arch |
| `D15-enforce` | 16 | 15-ENFORCEMENT.md | `anthropic` | `claude_doc`, `arch_doc` | `enforcement_rules` | D3-arch, D14-claude |
| `D16-infra` | 17 | 16-INFRA-DESIGN.md | `anthropic` | `arch_doc`, `data_model`, `api_contracts` | `infra_design` | D3-arch, D10-data, D11-api |
| `D17-migration` | 18 | 17-MIGRATION-PLAN.md | `anthropic` | `arch_doc`, `data_model`, `api_contracts`, `roadmap_doc` | `migration_plan` | D1-roadmap, D3-arch, D10-data, D11-api |
| `D18-testing` | 19 | 18-TESTING.md | `anthropic` | `arch_doc`, `quality_doc`, `data_model`, `claude_doc`, `mcp_tool_spec`, `design_spec`, `interaction_map` | `test_strategy` | D3-arch, D5-quality, D7-interaction, D8-mcp, D9-design, D10-data, D14-claude |
| `D19-fault` | 20 | 19-FAULT-TOLERANCE.md | `anthropic` | `arch_doc`, `data_model`, `api_contracts`, `quality_doc` | `fault_tolerance` | D3-arch, D5-quality, D10-data, D11-api |
| `D20-guardrails` | 21 | 20-GUARDRAILS-SPEC.md | `anthropic` | `arch_doc`, `quality_doc`, `data_model`, `api_contracts`, `fault_tolerance` | `guardrails_spec` | D3-arch, D5-quality, D10-data, D11-api, D19-fault |
| `D21-compliance` | 22 | 21-COMPLIANCE-MATRIX.md | `anthropic` | `arch_doc`, `quality_doc`, `data_model`, `guardrails_spec`, `fault_tolerance` | `compliance_matrix` | D3-arch, D5-quality, D10-data, D19-fault, D20-guardrails |
| `D22-handoff` | 23 | 22-AGENT-HANDOFF-PROTOCOL.md | `anthropic` | `arch_doc`, `mcp_tool_spec`, `interaction_map` | `handoff_protocol` | D3-arch, D7-interaction, D8-mcp |
| `D23-diagram` | 24 | 23-AGENT-INTERACTION-DIAGRAM.md | `anthropic` | `handoff_protocol`, `arch_doc`, `interaction_map` | `interaction_diagram` | D3-arch, D7-interaction, D22-handoff |
...
|-------------|-----------|------------|---------|-------------|
| `raw_spec` | `text/markdown` | Orchestrator (pre-loaded) | D0-brd, D1-roadmap, D2-prd | The master build specification (input document) |
| `brd_doc` | `text/markdown` | D0-brd | (downstream) | Business requirements document |
| `roadmap_doc` | `text/markdown` | D1-roadmap | D14-claude, D17-migration | Project context, milestones, timeline |
| `prd_doc` | `text/markdown` | D2-prd | D3-arch, D4-features, D5-quality, D7-interaction, D9-design, D11-api, D12-stories, D13-backlog | Personas, journeys, capabilities |
| `arch_doc` | `text/markdown` | D3-arch | D4-features, D5-quality, D6-security, D7-interaction, D8-mcp, D10-data, D11-api, D13-backlog, D14-claude, D15-enforce, D16-infra, D17-migration, D18-testing, D19-fault, D20-guardrails, D21-compliance, D22-handoff | Architecture, service layer, infrastructure |
| `feature_catalog` | `text/markdown` | D4-features | D7-interaction, D8-mcp, D9-design, D10-data, D12-stories, D13-backlog | F-NNN features with interfaces[] |
| `quality_doc` | `text/markdown` | D5-quality | D6-security, D7-interaction, D8-mcp, D9-design, D10-data, D13-backlog, D18-testing, D19-fault, D20-guardrails, D21-compliance | Q-NNN non-functional requirements |
| `security_arch` | `text/markdown` | D6-security | (downstream) | Security architecture |
| `interaction_map` | `text/markdown` | D7-interaction | D8-mcp, D9-design, D10-data, D11-api, D12-stories, D13-backlog, D18-testing, D22-handoff, D23-diagram | Shared data shapes, interaction IDs, cross-interface journeys |
| `mcp_tool_spec` | `text/markdown` | D8-mcp | D10-data, D11-api, D13-backlog, D18-testing, D22-handoff | MCP tools referencing interaction IDs |
| `design_spec` | `text/markdown` | D9-design | D10-data, D11-api, D13-backlog | Screens referencing interaction IDs |
| `data_model` | `text/markdown` | D10-data | D11-api, D16-infra, D17-migration, D18-testing, D19-fault, D20-guardrails, D21-compliance | PostgreSQL schemas, indexes, migrations |
| `api_contracts` | `text/markdown` | D11-api | D16-infra, D17-migration, D19-fault, D20-guardrails | REST endpoint specifications |
| `user_stories` | `text/markdown` | D12-stories | (downstream) | User stories organized by epic |
| `backlog` | `text/markdown` | D13-backlog | (downstream) | S-NNN stories with interaction_ids |
| `claude_doc` | `text/markdown` | D14-claude | D15-enforce, D18-testing | Coding rules, patterns, conventions |
| `enforcement_rules` | `text/markdown` | D15-enforce | (downstream) | .claude/ rules and /new-interaction skill |
| `infra_design` | `text/markdown` | D16-infra | (downstream) | Infrastructure design |
| `migration_plan` | `text/markdown` | D17-migration | (downstream) | Migration plan |
| `test_strategy` | `text/markdown` | D18-testing | (downstream) | Test strategy with cross-interface tests |
| `fault_tolerance` | `text/markdown` | D19-fault | D20-guardrails, D21-compliance | Fault tolerance design |
| `guardrails_spec` | `text/markdown` | D20-guardrails | D21-compliance | Guardrails specification |
| `compliance_matrix` | `text/markdown` | D21-compliance | (downstream) | Compliance matrix |
| `handoff_protocol` | `text/markdown` | D22-handoff | D23-diagram | Agent handoff protocol |
| `interaction_diagram` | `text/markdown` | D23-diagram | (terminal) | Agent interaction diagrams |
...
Step 1:  D0-brd ──────────────────────────────────┐
         D1-roadmap ──────────────────────────────┤
         D2-prd ──────┬──────────────────────────┐│  (parallel: D0 || D1 || D2)
                       │                          ││
Step 4:                └──> D3-arch ──────────────┼┤
                                │                 ││
Step 5-6:              ┌───────┼────> D4-features ││  (parallel: D4 || D5)
                       │       └────> D5-quality  ││
                       │                │    │    ││
Step 7:                │       D6-security <──────┘│
                       │                │          │
Step 8:                │       D7-interaction <────┘
                       │           │        │
Step 9-10:             │    D8-mcp ─┤       ├─ D9-design   (parallel: D8 || D9)
                       │           │        │
Step 11:               │       D10-data <───┘
                       │           │
Step 12:               │       D11-api
                       │
Step 13-15:            ├──> D12-stories                    (parallel: D12 || D13 || D14)
                       ├──> D13-backlog
                       └──> D14-claude
                       │
Step 16-18:            ├──> D15-enforce                    (parallel: D15 || D16 || D17)
                       ├──> D16-infra
                       └──> D17-migration
                       │
Step 19:               └──> D18-testing
                       │
Step 20-21:            ├──> D19-fault                      (parallel: D19 || D20)
                       └──> D20-guardrails
                       │
Step 22:               └──> D21-compliance
                       │
Step 23:               └──> D22-handoff
                       │
Step 24:               └──> D23-diagram
...
| `step` | integer | Yes | Execution step number (1-24). Determines ordering within the topological sort. |
...
```python
"""
Orchestrator — Pipeline controller for the 24-document Full-Stack-First build.
"""
...
async def run_pipeline(config: PipelineConfig, store: SessionStore) -> PipelineResult:
    """
    Execute the 24-document pipeline.
...
|-------|---------|--------|-------------|-----------|
| 1 | 1-3 | `D0-brd`, `D1-roadmap`, `D2-prd` | 3-way parallel | All read only `raw_spec`, no interdependency |
| 2 | 4 | `D3-arch` | Sequential | Depends on `prd_doc` from Layer 1 |
| 3 | 5-6 | `D4-features`, `D5-quality` | 2-way parallel | Both depend on Layer 1-2 outputs, neither depends on the other |
| 4 | 7 | `D6-security` | Sequential | Depends on `arch_doc` + `quality_doc` from Layers 2-3 |
| 5 | 8 | `D7-interaction` | Sequential | Depends on `quality_doc` + `feature_catalog` from Layer 3 |
| 6 | 9-10 | `D8-mcp`, `D9-design` | **2-way parallel** | **The Full-Stack-First Sprint** — both read from `interaction_map`, neither reads the other |
| 7 | 11 | `D10-data` | Sequential | Depends on both `mcp_tool_spec` and `design_spec` from Layer 6 |
| 8 | 12 | `D11-api` | Sequential | Depends on `data_model` from Layer 7 |
| 9 | 13-15 | `D12-stories`, `D13-backlog`, `D14-claude` | 3-way parallel | All depend on upstream outputs, none depend on each other |
| 10 | 16-18 | `D15-enforce`, `D16-infra`, `D17-migration` | 3-way parallel | All depend on upstream outputs |
| 11 | 19 | `D18-testing` | Sequential | Depends on multiple upstream documents |
| 12 | 20-21 | `D19-fault`, `D20-guardrails` | 2-way parallel | Both depend on upstream, neither reads the other |
| 13 | 22 | `D21-compliance` | Sequential | Depends on `fault_tolerance` + `guardrails_spec` |
| 14 | 23 | `D22-handoff` | Sequential | Depends on `arch_doc` + `interaction_map` + `mcp_tool_spec` |
| 15 | 24 | `D23-diagram` | Sequential | Depends on `handoff_protocol` |

**Maximum parallelism:** 3 agents (Layers 1, 9, and 10).
**Critical path:** D2-prd -> D3-arch -> D5-quality -> D7-interaction -> D8-mcp -> D10-data -> D11-api -> D18-testing -> D19-fault -> D21-compliance -> D22-handoff -> D23-diagram (12 sequential steps).
**Estimated wall-clock time:** ~10-15 minutes for a full run (24 agent calls, 15 sequential layers).
...
```json
{
  ...
  "summary": "24/24 documents generated. 2 conditional (flagged for human review). Total cost: $11.50 / $25.00 ceiling."
}
```
...
|------|-------------|----------|----------------|---------------|
| `full` | Execute all 24 agents from scratch. Ignores any existing session keys. | First-time generation, clean regeneration after major spec changes. | All 24 | $15-25 (generation) + $2.50-5.00 (quality gates) = **$18-30** |
...
```bash
# ─────────────────────────────────────────────────
# MODE: full — Generate all 24 documents from scratch
# ─────────────────────────────────────────────────
sdlc-pipeline run \
  --mode full \
...
# [14:25:01] Layer 1: D0-brd, D1-roadmap, D2-prd (parallel)
# [14:25:30] Layer 1 complete ($2.40, 29s)
# [14:25:31] Layer 2: D3-arch
# [14:26:10] Layer 2 complete ($1.20, 39s)
# ...
# [14:31:20] Pipeline complete. 24/24 documents generated.
...
# [15:00:01] Found 8/24 completed keys: roadmap_doc, prd_doc, arch_doc,
...
# Output:
# [17:00:00] Validate-only mode: checking 24 documents
# [17:00:00] D0-brd:        0.93 PASS
# [17:00:00] D1-roadmap:    0.92 PASS
# [17:00:01] D2-prd:        0.94 PASS
# [17:00:02] D3-arch:       0.91 PASS
# [17:00:04] D4-features:   0.93 PASS
# [17:00:05] D5-quality:    0.90 PASS
# [17:00:06] D6-security:   0.91 PASS
# [17:00:07] D7-interaction:0.95 PASS
# [17:00:08] D8-mcp:        0.91 PASS
# [17:00:09] D9-design:     0.82 CONDITIONAL ⚠
# [17:00:10] D10-data:      0.89 PASS
# [17:00:11] D11-api:       0.87 PASS
# [17:00:12] D12-stories:   0.91 PASS
# [17:00:13] D13-backlog:   0.79 CONDITIONAL ⚠
# [17:00:14] D14-claude:    0.88 PASS
# [17:00:15] D15-enforce:   0.90 PASS
# [17:00:16] D16-infra:     0.89 PASS
# [17:00:17] D17-migration: 0.87 PASS
# [17:00:18] D18-testing:   0.86 PASS
# [17:00:19] D19-fault:     0.90 PASS
# [17:00:20] D20-guardrails:0.88 PASS
# [17:00:21] D21-compliance:0.92 PASS
# [17:00:22] D22-handoff:   0.91 PASS
# [17:00:23] D23-diagram:   0.89 PASS
# Validation complete. 22 PASS, 2 CONDITIONAL, 0 FAIL
...
# ├─────────┼──────────────────────────┼───────────┼──────────────┤
# │ 1       │ D0-brd, D1-roadmap,      │ 3-way     │ $1.80-2.70   │
# │         │ D2-prd                   │           │              │
# │ 2       │ D3-arch                  │ —         │ $0.80-1.20   │
# │ 3       │ D4-features, D5-quality  │ 2-way     │ $1.20-1.80   │
# │ 4       │ D6-security              │ —         │ $0.80-1.20   │
# │ 5       │ D7-interaction           │ —         │ $1.00-1.50   │
# │ 6       │ D8-mcp, D9-design       │ 2-way     │ $1.40-2.00   │
# │ 7       │ D10-data                 │ —         │ $0.80-1.20   │
# │ 8       │ D11-api                  │ —         │ $0.80-1.20   │
# │ 9       │ D12-stories, D13-backlog,│ 3-way     │ $1.80-2.70   │
# │         │ D14-claude               │           │              │
# │ 10      │ D15-enforce, D16-infra,  │ 3-way     │ $1.80-2.70   │
# │         │ D17-migration            │           │              │
# │ 11      │ D18-testing              │ —         │ $0.80-1.20   │
# │ 12      │ D19-fault, D20-guardrails│ 2-way     │ $1.20-1.80   │
# │ 13      │ D21-compliance           │ —         │ $0.80-1.20   │
# │ 14      │ D22-handoff              │ —         │ $0.80-1.20   │
# │ 15      │ D23-diagram              │ —         │ $0.80-1.20   │
# ├─────────┼──────────────────────────┼───────────┼──────────────┤
# │ TOTAL   │ 24 agents, 15 layers     │           │ $17.60-26.80 │
# │ +QGates │ 24 quality gates          │           │ $2.40-4.80   │
# │ GRAND   │                           │           │ $20.00-31.60 │
# └─────────┴──────────────────────────┴───────────┴──────────────┘
#
# Estimated wall-clock time: 10-15 minutes
...
|--------|----------------------------------|------------------|
| `D1-roadmap` | D1, D14, D17 and downstream | D0, D2-D13, D15-D16, D18-D23 (except downstream) |
| `D2-prd` | D2, D3 and all downstream | D0, D1 |
| `D3-arch` | D3 and all downstream (D4-D23) | D0, D1, D2 |
| `D7-interaction` | D7, D8, D9, D10, D11 and downstream | D0-D6, D12-D15 (except downstream) |
| `D8-mcp` | D8, D10, D11 and downstream | D0-D7, D9, D12-D15 (except downstream) |
| `D9-design` | D9, D10, D11 and downstream | D0-D8, D12-D15 (except downstream) |
| `D10-data` | D10, D11 and downstream | D0-D9, D12-D15 (except downstream) |
| `D11-api` | D11 and downstream | D0-D10, D12-D15 (except downstream) |
| `D23-diagram` | D23 | All others (terminal document) |
...
| Agent | raw_spec | brd | roadmap | prd | arch | features | quality | security | interaction | mcp_tool | design | data_model | api |
|-------|----------|-----|---------|-----|------|----------|---------|----------|-------------|----------|--------|------------|-----|
| D0-brd | R | **W** | | | | | | | | | | | |
| D1-roadmap | R | | **W** | | | | | | | | | | |
| D2-prd | R | | | **W** | | | | | | | | | |
...
| D5-quality | | | | R | R | | **W** | | | | | | |
| D6-security | | | | | R | | R | **W** | | | | | |
| D7-interaction | | | | R | R | R | R | | **W** | | | | |
| D8-mcp | | | | | R | R | R | | R | **W** | | | |
| D9-design | | | | R | | R | R | | R | | **W** | | |
| D10-data | | | | | R | R | R | | R | R | R | **W** | |
| D11-api | | | | R | R | | | | R | R | R | R | **W** |
| D12-stories | | | | R | | R | | | R | | | | |
| D13-backlog | | | | R | R | R | R | | R | R | R | | |
| D14-claude | | | R | | R | | | | | | | | |
| D15-enforce | | | | | R | | | | | | | | |
| D16-infra | | | | | R | | | | | | | R | R |
| D17-migration | | | R | | R | | | | | | | R | R |
| D18-testing | | | | | R | | R | | R | R | R | R | |
| D19-fault | | | | | R | | R | | | | | R | R |
| D20-guardrails | | | | | R | | R | | | | | R | R |
| D21-compliance | | | | | R | | R | | | | | R | |
| D22-handoff | | | | | R | | | | R | R | | | |
| D23-diagram | | | | | R | | | | R | | | | |
...
|----------|-------------|----------------|------------|
| D0-brd | `brd_doc` | `Generated-Docs/00-BRD.md` | 00 |
| D1-roadmap | `roadmap_doc` | `Generated-Docs/01-ROADMAP.md` | 01 |
| D2-prd | `prd_doc` | `Generated-Docs/02-PRD.md` | 02 |
| D3-arch | `arch_doc` | `Generated-Docs/03-ARCH.md` | 03 |
| D4-features | `feature_catalog` | `Generated-Docs/04-FEATURE-CATALOG.md` | 04 |
| D5-quality | `quality_doc` | `Generated-Docs/05-QUALITY.md` | 05 |
| D6-security | `security_arch` | `Generated-Docs/06-SECURITY-ARCH.md` | 06 |
| D7-interaction | `interaction_map` | `Generated-Docs/07-INTERACTION-MAP.md` | 07 |
| D8-mcp | `mcp_tool_spec` | `Generated-Docs/08-MCP-TOOL-SPEC.md` | 08 |
| D9-design | `design_spec` | `Generated-Docs/09-DESIGN-SPEC.md` | 09 |
| D10-data | `data_model` | `Generated-Docs/10-DATA-MODEL.md` | 10 |
| D11-api | `api_contracts` | `Generated-Docs/11-API-CONTRACTS.md` | 11 |
| D12-stories | `user_stories` | `Generated-Docs/12-USER-STORIES.md` | 12 |
| D13-backlog | `backlog` | `Generated-Docs/13-BACKLOG.md` | 13 |
| D14-claude | `claude_doc` | `Generated-Docs/14-CLAUDE.md` | 14 |
| D15-enforce | `enforcement_rules` | `Generated-Docs/15-ENFORCEMENT.md` | 15 |
| D16-infra | `infra_design` | `Generated-Docs/16-INFRA-DESIGN.md` | 16 |
| D17-migration | `migration_plan` | `Generated-Docs/17-MIGRATION-PLAN.md` | 17 |
| D18-testing | `test_strategy` | `Generated-Docs/18-TESTING.md` | 18 |
| D19-fault | `fault_tolerance` | `Generated-Docs/19-FAULT-TOLERANCE.md` | 19 |
| D20-guardrails | `guardrails_spec` | `Generated-Docs/20-GUARDRAILS-SPEC.md` | 20 |
| D21-compliance | `compliance_matrix` | `Generated-Docs/21-COMPLIANCE-MATRIX.md` | 21 |
| D22-handoff | `handoff_protocol` | `Generated-Docs/22-AGENT-HANDOFF-PROTOCOL.md` | 22 |
| D23-diagram | `interaction_diagram` | `Generated-Docs/23-AGENT-INTERACTION-DIAGRAM.md` | 23 |
...
*End of document. This protocol governs the meta-pipeline that generates SDLC specification documents. For the runtime agent protocol (48 agents across 7 SDLC phases), see the ARCH (Doc 03) and MCP-TOOL-SPEC (Doc 08).*
