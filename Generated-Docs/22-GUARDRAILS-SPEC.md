...
**Document:** 22 (Extended) | Status: Draft
**Reads from:** ARCH (Doc 2), QUALITY (Doc 4), DATA-MODEL (Doc 9), API-CONTRACTS (Doc 10), FAULT-TOLERANCE (Doc 21)
...
**Quality dimensions (from QUALITY Doc 4):**
...
**Autonomy tiers (from ARCH Doc 2):**
